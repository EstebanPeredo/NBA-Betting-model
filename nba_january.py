...
january = "https://www.basketball-reference.com/leagues/NBA_2023_games-january.html"

response = requests.get(january)
...
with open('schedule.csv', 'a', newline='') as csv_file:
    ...
    for away_team, away_team_points, home_team, home_team_points, margin in zip(away_team_list, away_points_list,
                                                                                home_team_list, home_points_list,
                                                                                margin_list):
